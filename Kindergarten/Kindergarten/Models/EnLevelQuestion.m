...
-(NSString*)description
{
    ...
    for (int i=0; i<self.questionArray.count; i++) {
        ...
        questionAndProveHtml = [NSString stringWithFormat:@"<table class=\"table table-condensed\"><thead><tr scrollid=\"scroll_%@\"><td style=\"vertical-align: middle; background-color: white; width: 74%%; \">%@</td><td style=\"vertical-align: middle; width: 1%%;\"></td><td style=\"vertical-align: middle; background-color: white; width: 25%%;\">%@</td></tr></thead></table>",question.pkId,[question description],[aprove description]];
