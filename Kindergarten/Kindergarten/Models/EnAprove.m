...
-(NSString*)description
{
    ...
    NSString* aproveHtml=@"<table class=\"table table-condensed\" style=\"border-top: 0px solid white;\"><thead><tr></tr><tr></tr><tr></tr></thead></table><div><textarea class=\"form-control\" rows=\"3\" placeholder=\"请输入文字内容\"></textarea></div>";
