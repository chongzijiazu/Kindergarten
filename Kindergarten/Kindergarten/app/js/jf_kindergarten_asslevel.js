...
function showLevelTable(data){
    ...
    for(var i = 0; i<arrayData.length;i++){
        ...
        row += '<td '+level.sid+' style="background-color:#FDFFF5;padding-left:8%;">'+level.sname+'</td>';
        row += '<td onclick=showQuestion('+level.tid+'); '+level.tid+' style="background-color:#FEF0FA;padding-left:20%;">'+level.tname+'</td>';
