...
;(function ($) {
  $.fn.spinner = function (opts) {
    return this.each(function () {
      var defaults = {value:0, min:0, max:1000, maxlength:2}
      ...
      var textField = $(this).addClass('value').attr('maxlength', options.maxlength).val(options.value)
        .bind('keyup paste change', function (e) {
          if($(this).val()=="") return;
          var spinner_temp_val = $(this).val().replace(/[\D]+/g, '');
          spinner_temp_val = parseInt(spinner_temp_val || 0);
          $(this).val(spinner_temp_val);
          var field = $(this)
